...
function spiralTraversal(dimensional){
  var result = [];
  var spiral = function(dimensional, result){
    
  }
  //add the first row
  //the last element for each row
  //add the last row from right to left
  //add the first element for each row from bottom to top
  // repeat (recursion) until it is finished
  //console log results
}